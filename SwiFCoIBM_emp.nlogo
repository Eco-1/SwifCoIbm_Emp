;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;                                                                                                                                                                                                                                                           ;;
;;  SwiFCoIBM-Emp - Individual-Based Swine Fever Community Model with explicit movement (based on model versions published in Kramer-Schadt et al. 2009, Lange et al. 2012 and Scherer et al. 2020)                                                                              ;;
;;                                                                                                                                                                                                                                                           ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
[
  ...
  immSubAdult                 ;output counter variable
  immPiglett                  ;output counter variable
  infAdult_samp               ;output counter variable
  infSubAdult_samp            ;output counter variable
  infPiglett_samp             ;output counter variable
  immAdult_samp               ;output counter variable
  immSubAdult_samp            ;output counter variable
  immPiglett_samp             ;output counter variable
  dba_Indiv                   ;output counter variable
  dba_IndivImmune             ;output counter variable
  dbr_Adult                   ;output counter variable
  dbr_SubAdult                ;output counter variable
  dbr_piglet                  ;output counter variable
...
to loadList
  ...
  ask patches
  [
    if member? RealDataAreaCode rDataAreaCodeList
    [
      if (file-exists? word "AreaCodeSamplerFiles/" word RealDataAreaCode "_times.txt" )
      [
        file-open (word "AreaCodeSamplerFiles/" word RealDataAreaCode "_times.txt")
        while [ not file-at-end? ]
        [
          let nextValue file-read ;; iterate over file entries seperated by white-space
          set sampleTimeList fput nextValue sampleTimeList

        ]
        file-close
      ]

      if (file-exists? word "AreaCodeSamplerFiles/" word RealDataAreaCode "_nSamples.txt" )
      [
        file-open (word "AreaCodeSamplerFiles/" word  RealDataAreaCode "_nSamples.txt")
        while [ not file-at-end? ]
        [
          let nextValue file-read ;; iterate over file entries seperated by white-space
          set nSampleList fput nextValue nSampleList
        ]
        file-close
      ]
     set rDataAreaCodeList remove RealDataAreaCode rDataAreaCodeList
    ]
  ]
...
to Init_Parameters
 ...
 ; set b_move bfct
 ; set b_within bfct
  ;set b_between ((bfct / 100)- 0.00002)
  ...
  let runIDt random 100000000
  set runID word "RID" word runIDt "RIDEND"
  ...
  ask patches [
    ...
    set deadHere 0
    set currentInfectedHere 0

    set deathByAge 0
    set deathByDisease 0
    set deathByDiseaseAdult 0
    set deathByDiseaseSubAdult 0
    set deathByDiseasePiglet 0
    set deathByRandom 0
    set deathByRandomAdult 0
    set deathByRandomSubAdult 0
    set deathByRandomPiglet 0
    set deathByAge_C 0
    set deathByDisease_C 0
    set deathByDiseaseAdult_C 0
    set deathByDiseaseSubAdult_C 0
    set deathByDiseasePiglet_C 0
    set deathByRandom_C 0
    set deathByRandomAdult_C 0
    set deathByRandomSubAdult_C 0
    set deathByRandomPiglet_C 0

    set deadImmuneHere 0
    set deadImmuneAdult 0
    set deadImmuneSubAdult 0
    set deadImmunePiglet 0
    set deadImmuneHere_C 0
    set deadImmuneAdult_C 0
    set deadImmuneSubAdult_C 0
    set deadImmunePiglet_C 0
  ]
  ...
  set immPiglett 0
  set infAdult_samp 0
  set infSubAdult_samp 0
  set infPiglett_samp 0
  set immAdult_samp 0
  set immSubAdult_samp 0
  set immPiglett_samp 0
  set dba_Indiv 0
  set dba_IndivImmune 0
  set dbr_Adult 0
  set dbr_SubAdult 0
  set dbr_piglet 0
  set dbr_AdultImmune 0
  set dbr_SubAdultImmune 0
  set dbr_pigletImmune 0
  set Vaccinated 0
...
to Init_Landscape
  ...
  while [ y < max-pycor + 1 ]
   ...
   let dataset gis:load-dataset "input/mvp_habitat_cutMcPom.asc"
   gis:set-transformation (gis:envelope-of dataset) (list min-pxcor max-pxcor min-pycor max-pycor)
   let c gis:width-of dataset
   let r gis:height-of dataset

     gis:apply-raster dataset quality

    ask patches [  ;filter NaN values introduced by the GIS extension
      ifelse (quality <= 0) or (quality >= 0)
      []
      [
        set quality -1
      ]
     ...
     let areaCodeTMP gis:load-dataset "input/GemNum.asc"

     gis:set-transformation (gis:envelope-of areaCodeTMP) (list min-pxcor max-pxcor min-pycor max-pycor)
     ask patches[set areaCode -1]
     gis:apply-raster areaCodeTMP areaCode

    ask patches [  ;filter NaN values introduced by the GIS extension
      ifelse (areaCode <= 0) or (areaCode >= 0)
      []
      [
        set areaCode -1
      ]
      set areaCodeList fput areaCode areaCodeList


    ]
    set areaCodeList remove-duplicates areaCodeList


    let rdArea gis:load-dataset "input/mvp_realData_raster.asc"

    ask patches[set RealDataAreaCode -1]

    gis:apply-raster rdArea RealDataAreaCode


    ask patches [
     ifelse (RealDataAreaCode <= 0) or (RealDataAreaCode >= 0)
      []
      [
        set RealDataAreaCode -1
      ]

      set rDataAreaCodeList fput RealDataAreaCode rDataAreaCodeList
    ]

    set rDataAreaCodeList remove-duplicates rDataAreaCodeList
    set rDataAreaCodeList remove -1 rDataAreaCodeList


      ;vaccination 1

  let VacRas1 gis:load-dataset "input/vaccination_realistic_belt.asc"

  ask patches[set Vacc1 -1]

  gis:apply-raster VacRas1 Vacc1


  ask patches [
    ifelse (Vacc1 <= 0) or (Vacc1 >= 0)
      []
    [
      set Vacc1 -1
    ]
  ...
  let VacRas2 gis:load-dataset "input/vaccination_realistic_intermediate.asc"

  ask patches[set Vacc2 -1]

  gis:apply-raster VacRas2 Vacc2


  ask patches [
    ifelse (Vacc2 <= 0) or (Vacc2 >= 0)
      []
    [
      set Vacc2 -1
    ]
  ...
  let VacRas3 gis:load-dataset "input/vaccination_realistic_lateStage.asc"

  ask patches[set Vacc3 -1]

  gis:apply-raster VacRas3 Vacc3


  ask patches [
    ifelse (Vacc3 <= 0) or (Vacc3 >= 0)
      []
    [
      set Vacc3 -1
    ]
...
to Disease_Release
  ...
  ask patch 63 58;(max-pxcor / 2) max-pycor
  [
    set inf_x pxcor
    set inf_y pycor
...
to Host_Death
  ...
  [
    ifelse Age > 34
    [
      if random-float 1 < (1 - (survival_prob ^ (1 / 52))) [
        set aboutToDie true
        set dbr true
      ]
    ][  ;; mean survival probability for yearlings (Gaillard et al. 1987) = 0.65 = mean survival probability for adults (Focardi et al. 1996)
      if random-float 1 < (1 - (survival_prob_pig ^ (1 / 52))) [
        set aboutToDie true
        set dbr true
      ]
    ]
  if (epi_stat = "esLeth")[
    if tick_leth = ticks [ set aboutToDie true ]
    ask patch-here [set deadHere deadHere + 1]
  ]

  if (age >= max_age) [ set aboutToDie true ]
...
;
  ...
  ;ask turtles with [age >= max_age] [ set aboutToDie true ]
...
to Movement_Roaming
  ...
  [
    ...
    [
      ...
      if epi_stat = "esLeth" [
        while [ dist > 20 ] [ set dist (Report_Weibull 1.3 26) + 1 ]
      ]
      set dist_move dist
...
to View
 ...
 ; ask habitat with [is_infectious = 1] [ set pcolor scale-color green quality 12 0 ]
  ask habitat with [deathByDisease_C > 0] [ set pcolor scale-color orange deathByDisease_C 40 0 ]
...
to sample
   ...
   if sampleSetup = "full" ;record every individual
  [
      ask patches
  [
    set deathByAge 0
  ...
  ask patches with [any? turtles-here with [aboutToDie = true ]]
  [

    ask turtles-here with [aboutToDie = true]
    [

              let tested false
              if Age > max_age AND tested = false
              [
                set deathByAge deathByAge + 1
                set deathByAge_C deathByAge_C + 1
                set dba_Indiv dba_Indiv + 1
                if epi_stat = "esImm"
                [
                  set deadImmuneHere deadImmuneHere + 1
                  set deadImmuneAdult deadImmuneAdult + 1

                  set deadImmuneHere_C deadImmuneHere_C + 1
                  set deadImmuneAdult_C deadImmuneAdult_C + 1
                  set dba_IndivImmune dba_IndivImmune + 1
                ]
                if epi_stat = "esImmMat"
                [
                  set deadImmuneHere deadImmuneHere + 1
                  set deadImmuneHere_C deadImmuneHere_C + 1
                  set immPiglett_samp immPiglett_samp + 1
                ]
                set tested true
              ]
              if epi_stat = "esLeth" AND tick_leth = ticks AND tested = false
              [
                set deathByDisease deathByDisease + 1
                set deathByDisease_C deathByDisease_C + 1
                if age_group = "piglet"
                [
                  set deathByDiseasePiglet deathByDiseasePiglet + 1
                  set deathByDiseasePiglet_C deathByDiseasePiglet_C + 1
                  set infPiglett_samp infPiglett_samp + 1
                ]
                if age_group = "subadult"
                [
                  set deathByDiseaseSubAdult deathByDiseaseSubAdult + 1
                  set deathByDiseaseSubAdult_C deathByDiseaseSubAdult_C + 1
                  set infSubAdult_samp infSubAdult_samp + 1
                ]
                if  age_group = "adult"
                [
                  set deathByDiseaseAdult deathByDiseaseAdult + 1
                  set deathByDiseaseAdult_C deathByDiseaseAdult_C + 1
                  set infAdult_samp infAdult_samp + 1
                ]
                set tested true
              ]
              if dbr = true AND tested = false
              [
                set deathByRandom deathByRandom + 1
                set deathByRandom_C deathByRandom_C + 1

                if age_group = "piglet"
                [
                  set deathByRandomPiglet deathByRandomPiglet + 1
                  set deathByRandomPiglet_C deathByRandomPiglet_C + 1
                  set dbr_piglet dbr_piglet + 1

                  if epi_stat = "esImmMat"
                  [
                    set deadImmunePiglet  deadImmunePiglet + 1
                    set deadImmunePiglet_C  deadImmunePiglet_C + 1
                    set deadImmuneHere deadImmuneHere + 1
                    set deadImmuneHere_C deadImmuneHere_C + 1
                    set dbr_pigletImmune dbr_pigletImmune + 1
                    set immPiglett_samp immPiglett_samp + 1
                  ]
                  if epi_stat = "esImm"
                  [
                ...
                if age_group = "subadult"
                [
                  set deathByRandomSubAdult deathByRandomSubAdult + 1
                  set deathByRandomSubAdult_C deathByRandomSubAdult_C + 1
                  set dbr_SubAdult dbr_SubAdult + 1

                  if epi_stat = "esImm"
                  [
                    set deadImmuneSubAdult  deadImmuneSubAdult + 1
                    set deadImmuneSubAdult_C  deadImmuneSubAdult_C + 1
                    set deadImmuneHere deadImmuneHere + 1
                    set deadImmuneHere_C deadImmuneHere_C + 1
                    set dbr_SubAdultImmune dbr_SubAdultImmune + 1
                    set immSubAdult_samp immSubAdult_samp + 1
                  ]

                ]
                if  age_group = "adult"
                [
                  set deathByRandomAdult deathByRandomAdult + 1
                  set deathByRandomAdult_C deathByRandomAdult_C + 1
                  set dbr_Adult dbr_Adult + 1
                  ...
                  [
                    ...
                    set deadImmuneHere deadImmuneHere + 1
                    set deadImmuneHere_C deadImmuneHere_C + 1
                    set dbr_AdultImmune dbr_AdultImmune + 1
                    set immAdult_samp immAdult_samp + 1
                  ]
  ...
  if sampleSetup = "real" ; sampling during the actual outbreak
  [
    ask patches
    [
      set deathByAge 0
...
to realSample
  ...
  if ticks > week_release[

    ask patches with [not empty? sampleTimeList] ;; finding patches with both sampling list filled which will be representing the entire municipality
    [
      (foreach sampleTimeList nSampleList ;;iterate thought the time list
        [
          [a b] -> if (a = (ticks - week_release)) ;; if current tick is in the time list we take the entry at the same index in the number of samples lsit and take those samples
          [
            ; print "sampling"
            let toSampleHere b
            ;  print b
            let tempAC RealDataAreaCode

            ask at-most-n-of toSampleHere turtles with [tempAc = [RealDataAreaCode] of patch-here AND aboutToDie = TRUE] ;; all agents within patches of the same areacode
            [
...
to executeDeath
  ...
  ask turtles with [aboutToDie = true][die]
...
to liveCount
  ...
  ask habitat
  [
    if any? turtles-here  with [epi_stat = "esLeth"]
    [
    set currentInfectedHere count turtles-here with [epi_stat = "esLeth"]
    ]
  ]

  set infAdult count turtles with [epi_stat = "esLeth"  AND age_group = "adult"]
  set infSubAdult count turtles with [epi_stat = "esLeth"  AND age_group = "subadult"]
  set infPiglett count turtles with [epi_stat = "esLeth"  AND age_group = "piglet"]

  set immAdult count turtles with [epi_stat = "esImm" AND  age_group = "adult"]
  set immSubAdult count turtles with [epi_stat = "esImm" AND age_group = "subadult"]
  set immPiglett count turtles with [epi_stat = "esImm" AND age_group = "piglet"]
...
to countOutput
  ...
  set ct_Sus count turtles with [epi_stat = "esSusc"]
  set ct_Imm count turtles with [epi_stat = "esImm"]
  set ct_Let count turtles with [epi_stat = "esLeth"]

  end

to writeLandscape

let landscape_Infected gis:patch-dataset deathByDisease_C
let filename_InfHere(word "/outputRaster/" runID "_deadByDiseaseHerec" "_vs_" VaccinationPercentageSubadult "_va_" VaccinationPercentageAdult "_BetaMove_" b_move "_BetaWithin_" b_within "_BetaBetween_" b_between "_Mue_" mue "_MoveType_" roaming "_tick_" ticks  ".asc")
if (file-exists? filename_InfHere) [file-delete filename_InfHere]
gis:store-dataset landscape_Infected filename_InfHere


let landscape_RealDataAreaCode gis:patch-dataset RealDataAreaCode
let filename_RealDataAreaCode(word "/outputRaster/" runID "_RealDataAreaCode" "_vs_" VaccinationPercentageSubadult "_va_" VaccinationPercentageAdult "_BetaMove_" b_move "_BetaWithin_" b_within "_BetaBetween_" b_between "_Mue_" mue "_MoveType_" roaming "_tick_" ticks  ".asc")
if (file-exists? filename_RealDataAreaCode) [file-delete filename_RealDataAreaCode]
gis:store-dataset landscape_RealDataAreaCode filename_RealDataAreaCode


let landscape_AreaCode gis:patch-dataset areaCode
let filename_AreaCode(word "/outputRaster/" runID "_AreaCode" "_vs_" VaccinationPercentageSubadult "_va_" VaccinationPercentageAdult "_BetaMove_" b_move "_BetaWithin_" b_within "_BetaBetween_" b_between "_Mue_" mue "_MoveType_" roaming "_tick_" ticks  ".asc")
if (file-exists? filename_AreaCode) [file-delete filename_AreaCode]
gis:store-dataset landscape_AreaCode filename_AreaCode
...
to askVac
  ...
  ask  turtles-here with [epi_stat = "esSusc" AND age_group = "subadult"]
      [
        if random 100 < VaccinationPercentageSubadult / 4
        [
          execVac
        ]
      ]
      ask  turtles-here with [epi_stat = "esSusc" AND age_group = "adult"]
      [
        if random 100 < VaccinationPercentageAdult / 4
        [
          execVac
        ]
      ]
...
to vaccinate
    ...
    if ticks >= week_release + 40 AND ticks < week_release + 239
    [
     execVaccinate
    ]

    if ticks >= week_release + 240 AND ticks < week_release + 375
    [
      execVaccinate
    ]

    if ticks >= week_release + 376 AND ticks < week_release + 600
    [
    execVaccinate
    ]
...
to execVaccinate
   ...
   ifelse ticks mod 52 = 13 [vac3][
    ifelse ticks mod 52 = 26 [vac3][
      ifelse ticks mod 52 = 39 [vac3][
        if ticks mod 52 = 52 [vac3]]]]
...
181
Default Values
;; CONTROL\nset run_years 12\nset seed_setup \"OFF\"\nset seed 1\n\n;; LANDSCAPE\nset file \"hom\"\nset mean_quality 4.5\nset mvp_on true\nset sampleSetup \"real\"\nset realistic_vaccination true\nset VaccinationPercentageAdult 30\nset VaccinationPercentageSubAdult 6\n\n;; HOST POPULATION\nset herd_prop 100\nset release_fct 4.5\nset longevity 11\nset age_blur 6\nset fem_prob 0.5\nset dist_disp 3\n\n;; DISEASE DYNAMICS\nset year_release 2\nset fert_red 0.625\nset fetal_inf 0.5\nset case_fatality 0.5\nset b_within 0.044\nset b_between 0.0044\nset b_move 0.044\nset mue 8\nset mue_max 10\nset t_trans 1\nset t_anti 12\n\n;; MOVEMENT\nset q 0.7\nset Roaming \"HD\"
NIL
1
T
OBSERVER
...
@#$#@#$#@
<experiments>
  <experiment name="AreaCode_msRun2" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count turtles</metric>
    <metric>areaCodesWithInfection</metric>
    <metric>ct_Sus</metric>
    <metric>ct_Imm</metric>
    <metric>ct_Let</metric>
    <metric>infAdult</metric>
    <metric>infSubAdult</metric>
    <metric>infPiglett</metric>
    <metric>immAdult</metric>
    <metric>immSubAdult</metric>
    <metric>immPiglett</metric>
    <metric>infAdult_samp</metric>
    <metric>infSubAdult_samp</metric>
    <metric>infPiglett_samp</metric>
    <metric>immAdult_samp</metric>
    <metric>immSubAdult_samp</metric>
    <metric>immPiglett_samp</metric>
    <metric>dba_Indiv</metric>
    <metric>dba_IndivImmune</metric>
    <metric>dbr_Adult</metric>
    <metric>dbr_SubAdult</metric>
    <metric>dbr_piglet</metric>
    <metric>dbr_AdultImmune</metric>
    <metric>dbr_SubAdultImmune</metric>
    <metric>dbr_pigletImmune</metric>
    <metric>Vaccinated</metric>
    <metric>runID</metric>
    ...
    <enumeratedValueSet variable="mvp_on">
      <value value="true"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="sampleSetup">
      <value value="&quot;real&quot;"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="realistic_vaccination">
      <value value="true"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="VaccinationPercentageSubadult">
      <value value="6"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="VaccinationPercentageAdult">
      <value value="30"/>
    </enumeratedValueSet>
